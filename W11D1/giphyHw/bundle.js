...
var fetchSearchGiphys = function fetchSearchGiphys(giphys) {
  return function (dispatch) {
    _util_api_util__WEBPACK_IMPORTED_MODULE_0__["fetchSearchGiphys"].then(function (giphys) {
...
var fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
  return $.ajax({
    //FORGOT TO RETURN
    method: 'GET',
    url: "http://api.giphy.com/v1/gifs/search?q=".concat(searchTerm, "&api_key=57JXANqIUzK3tk6Ly07UoiYwZiztTiuW&limit=2")
  });
};
